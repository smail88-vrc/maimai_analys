...
var inner_lv = [
	...
	["8-", "12.3", ""],	//トルコ行進曲 - オワタ＼(^o^)／
	["8-", "9.9", ""],	//リリリリ★バーニングナイト
	["8-", "9.9", ""],	//イアイア★ナイトオブデザイア
	["7+", "10.4", ""],	//ルカルカ★ナイトフィーバー
	["7-", "9.9", ""],	//メグメグ☆ファイアーエンドレスナイト
	["8-", "9.2", ""],	//教えて!! 魔法のLyric
	["7-", "10.8", ""],	//おちゃめ機能
	...
	["8-", "10.3", ""],	//Heart Beats
	["7-", "9.9", ""],	//Sweetiex2
	["9-", "10.5", "12.1"],	//ロミオとシンデレラ
	["8-", "10.8", ""],	//ハッピーシンセサイザ
	["9-", "10.5", ""],	//ダンシング☆サムライ
	["8-", "10.7", ""],	//ハロ／ハワユ
	["8+", "9.7", "11-"],	//Tell Your World
	["8+", "11.2", ""],	//Hand in Hand
	["10-", "11.6", ""],	//アンハッピーリフレイン
	["9+", "12.6", ""],	//裏表ラバーズ
	["8-", "11.5", ""],	//ローリンガール
	["7-", "10.6", "12.1"],	//ワールズエンド・ダンスホール
	["8-", "9.9", "11+"],	//マトリョシカ
	["8-", "9.7", ""],	//パンダヒーロー
	["9+", "10.6", ""],	//ゴーゴー幽霊船
	["9-", "11.2", ""],	//セツナトリップ
	...
	["9-", "10.9", ""],	//YU-MU
	["9+", "12.0", ""],	//エテルニタス・ルドロジー
	["8-", "10.6", "11+"],	//エピクロスの虹はもう見えない
	["9-", "12.0", ""],	//四次元跳躍機関
	["9-", "12.3", ""],	//少女幻葬戦慄曲 ～ Necro Fantasia
	["8+", "11.5", ""],	//Jimang Shot
	["8-", "10.7", "11.5"],	//ってゐ！ ～えいえんてゐVer～
	...
	["8+", "10.9", "12.3"],	//Bad Apple!! feat nomico
	["9-", "10.8", ""],	//CALL HEAVEN!! 
	["8+", "11.0", ""],	//Sunshine world tour 
	["9-", "11.5", ""],	//終わりなき物語
	["9-", "11.1", ""],	//Our Fighting
	["8+", "11.9", "11.9"],	//Save This World νMIX
	["8+", "10.5", "11.4"],	//Living Universe
...
function analyzing_rating()
{
	...
	if(confirm(str))
	{
		...
		window.open("https://twitter.com/share?hashtags=maiAnalyzer&text=" + str);
	}
