...
var inner_lv = [
	...
	{levels:["11.5", "11.5", ""],	name:"Urban Crusher {levels:[Remix]"},
	...
	{levels:["9+", "12.5", ""],	name:"Space Harrier Main Theme {levels:[Reborn]"},
	{levels:["10-", "11.6", ""],	name:"Quartet Theme {levels:[Reborn]"},
	{levels:["9-", "11.2", ""],	name:"Sky High {levels:[Reborn]"},
	{levels:["9+", "12.5", ""],	name:"Like the Wind {levels:[Reborn]"},
	{levels:["11-", "11+", ""],	name:"YA･DA･YO {levels:[Reborn]"},
	...
	{levels:["9-", "12.1", ""],	name:"JACKY {levels:[Remix]"},
	...
	{levels:["9-", "11.6", ""],	name:"セガサターン起動音{levels:[H.]{levels:[Remix]"},
