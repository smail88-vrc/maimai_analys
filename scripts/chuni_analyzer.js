...
for(var i=0; i<mname_list.length; i++)
{
	...
	if(ma_list[i].lamp1!="")
		scoretable += '/ +' ma_list[i].lamp1
	scoretable += "</td>";
	scoretable += "<td>" + eval2pdata(chuni_music_list[i].lv[2], score2eval(ex_list[i].score));
	if(ex_list[i].lamp1!="")
		scoretable += '/ +' ex_list[i].lamp1
	scoretable += "</td>";
	scoretable += "<td>" + eval2pdata(chuni_music_list[i].lv[1], score2eval(adv_list[i].score));
	if(adv_list[i].lamp1!="")
		scoretable += '/ +' adv_list[i].lamp1
	scoretable += "</td>";
	scoretable += "<td>" + eval2pdata(chuni_music_list[i].lv[0], score2eval(ba_list[i].score));
	if(ba_list[i].lamp1!="")
		scoretable += '/ +' ba_list[i].lamp1
	scoretable += "</td>";
	scoretable += "</tr>";
}
scoretable += "</table>";
