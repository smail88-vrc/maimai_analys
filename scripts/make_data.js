...
document.write('<br>');
document.write('var lv11m_rslt=[' + lv11m_rslt.map((x)=>'"' + x.join('、 ') + '"').join('、 ') + '];');
document.write('<br>');
document.write('var lv10p_rslt=[' + lv10p_rslt.map((x)=>'"' + x.join('、 ') + '"').join('、 ') + '];');
document.write('<br>');
document.write('var lv10m_rslt=[' + lv10m_rslt.map((x)=>'"' + x.join('、 ') + '"').join('、 ') + '];');
document.write('<br>');
document.write('var lv9p_rslt=[' + lv9p_rslt.map((x)=>'"' + x.join('、 ') + '"').join('、 ') + '];');
document.write('<br>');
document.write('var lv9m_rslt=[' + lv9m_rslt.map((x)=>'"' + x.join('、 ') + '"').join('、 ') + '];');
document.write('<br>');
