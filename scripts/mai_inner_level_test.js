...
var maimai_inner_lv = [
	...
	{levels:["9-", "12.g", ""],	name:"回レ！雪月花", nick:""},
	...
	{levels:["10.0", "12.s", ""],	name:"初音ミクの消失", nick:"消失"},
	{levels:["9-", "11.6", ""],	name:"天ノ弱", nick:""},
	{levels:["9-", "12.e", ""],	name:"厨病激発ボーイ", nick:"厨病"},
	{levels:["10+", "12.t", ""],	name:"脳漿炸裂ガール", nick:"脳漿"},
	...
	{levels:["8-", "12.l", ""],	name:"赤心性：カマトト荒療治", nick:"カマトト"},
	{levels:["8-", "11.0", ""],	name:"イノコリ先生", nick:""},
	{levels:["9+", "12.g", ""],	name:"ECHO", nick:""},
	...
	{levels:["9.7", "12.t", ""],	name:"頓珍漢の宴", nick:"頓珍漢"},
	...
	{levels:["7-", "10.6", "12.l"],	name:"ワールズエンド・ダンスホール", nick:"ワールズエンド"},
	...
	{levels:["9-", "12.g", ""],	name:"Cosmic Magic Shooter", nick:"Magic Shooter"},
	...
	{levels:["10+", "12.t", ""],	name:"Scream out! -maimai SONIC WASHER Edit-", nick:"Scream Out"},
	...
	{levels:["10-", "12.t", ""],	name:"最終鬼畜妹・一部声", nick:"最終鬼畜妹"},
	{levels:["9-", "12.t", ""],	name:"ウサテイ", nick:""},
	...
	{levels:["11.0", "13.z", ""],	name:"Calamity Fortune", nick:"カラミティ"},
	...
	{levels:["9-", "12.g", ""],	name:"Back 2 Back", nick:"B2B"},
	...
	{levels:["8-", "10.1", "13.a"],	name:"In Chaos", nick:""},
	{levels:["10-", "10.5", "13.e"],	name:"Beat Of Mind", nick:""},
	{levels:["9-", "12.l", ""],	name:"JACKY [Remix]", nick:"Jacky"},
	...
	{levels:["9-", "10.2", "12.g"],	name:"Burning Hearts ～炎のANGEL～", nick:"Burning Hearts"},
	...
	{levels:["7-", "12.l", ""],	name:"KONNANじゃないっ！", nick:"KONNAN"},
	{levels:["9-", "11.6", ""],	name:"セガサターン起動音[H.][Remix]", nick:"セガサターン"},
	{levels:["10-", "12.s", ""],	name:"GO BACK 2 YOUR RAVE", nick:"GO BACK"},
	{levels:["10-", "12.q", ""],	name:"B.B.K.K.B.K.K.", nick:"BBKK"},
	{levels:["11.0", "12.s", ""],	name:"人里に下ったアタイがいつの間にか社畜になっていた件", nick:"社畜"},
	{levels:["10+", "12.s", ""],	name:"Maxi", nick:""},
	{levels:["9+", "12.l", ""],	name:"KISS CANDY FLAVOR", nick:"KISS CANDY"},
	...
	{levels:["10-", "12.g", ""],	name:"Party 4U ”holy nite mix”", nick:"Party 4U"},
	{levels:["9+", "11.8", ""],	name:"GOODMEN", nick:""},
	{levels:["10+", "12.b", ""],	name:"Sakura Fubuki", nick:"桜吹雪"},
	{levels:["10-", "12.s", ""],	name:"METATRON", nick:""},
	{levels:["9-", "11.5", ""],	name:"オモイヨシノ", nick:""},
	{levels:["9-", "12.g", ""],	name:"L9", nick:""},
	{levels:["10-", "12.q", ""],	name:"Jack-the-Ripper◆", nick:"Ripper"},
	{levels:["11.4", "12.s", ""],	name:"DRAGONLADY", nick:"ドラレ"},
	...
	{levels:["10-", "12.g", ""],	name:"DADDY MULK -Groove remix-", nick:"ダディ"},
	{levels:["10.2", "13.l", ""],	name:"FUJIN Rumble", nick:"FUJIN"},
	{levels:["10+", "12.t", ""],	name:"Got more raves？", nick:"ゴモア"},
	{levels:["11.0", "12.q", ""],	name:"夜明けまであと３秒", nick:"夜明けまで"},
	{levels:["10+", "12.q", ""],	name:"Ignis Danse", nick:"Ignis"},
	{levels:["11-", "12.s", ""],	name:"きたさいたま2000", nick:"きたさいたま"},
	{levels:["9-", "12.t", ""],	name:"Scars of FAUNA", nick:"FAUNA"},
	{levels:["10-", "12.b", ""],	name:"FLOWER", nick:""},
	{levels:["10.5", "12.s", ""],	name:"デスパレイト", nick:""},
	{levels:["11.2", "13.e", ""],	name:"Moon of Noon", nick:"Moon Noon"},
	{levels:["11-", "12.q", ""],	name:"Ultranova", nick:""},
	{levels:["10.4", "12.s", ""],	name:"KING is BACK!!", nick:"KING is BACK"},
	...
	{levels:["11.0", "12.s", ""],	name:"Garakuta Doll Play", nick:"ガラクタ"},
	...
	{levels:["11.3", "13.l", ""],	name:"Glorious Crown", nick:"グロクラ"},
	...
	{levels:["10-", "12.t", ""],	name:"DON’T  STOP  ROCKIN’", nick:"ドンスト"},
	{levels:["10-", "12.g", ""],	name:"oboro", nick:""},
	...
	{levels:["11.6", "13.l", ""],	name:"Fragrance", nick:"フレグラ"},
	{levels:["10-", "12.s", ""],	name:"Nerverakes", nick:"ナーブ"},
	...
	{levels:["9.5", "13.l", ""],	name:"ジングルベル", nick:"ジングル"},
	...
	{levels:["10-", "12.g", ""],	name:"My Dearest Song", nick:"しろな"},
...
function mra_diff2tmp(diff)
{
	var difftable =
		[["7-", 7.0], ["7+", 7.7], ["8-", 8.0], ["8+", 8.7], ["9-", 9.0], ["9+", 9.7],["10-", 10.0], 
		 ...
		 ["12.o", 12.0], ["12.l", 12.1], ["12.z", 12.2], ["12.e", 12.3], ["12.a", 12.4],
      		 ["12.g", 12.5], ["12.b", 12.6], ["12.t", 12.7], ["12.s", 12.8], ["12.q", 12.9],
		 ["13.o", 13.0], ["13.l", 13.1], ["13.z", 13.2], ["13.e", 13.3], ["13.a", 13.4],
		 ["13.g", 13.5], ["13.b", 13.6], ["13.t", 13.7], ["13.s", 13.8], ["13.q", 13.9]];
      		 // 'o', 'l', 'z', 'e', 'a', 'g', 'b', 't', 's', 'q'
