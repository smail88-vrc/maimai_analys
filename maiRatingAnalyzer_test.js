...
function print_result2(golliramode)
{
	...
	for(var i=0; i<datalist.length; i++)
	{
		...
		var max_rate = Math.max(diff2tmp(datalist[i].lv[1]), diff2tmp(datalist[i].lv[2]));
		...
		result_str += Math.round(Math.floor(datalist[i].music_rate/100))/100 + "<br>/<br>";
		result_str += max_rate + "<\/th>";
